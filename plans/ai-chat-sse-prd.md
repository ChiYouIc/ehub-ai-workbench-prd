...
> 决策记录：Q1–Q16 已于 2026-08-20 访谈确认（用户采纳全部推荐答案），终审通过，定版 v1.0。
> 内容已拆解至 `requirements/ai-chat/01~05` 与 `specs/ai-chat-spec.md`，本文作为**决策母本**保留。
...
- ①会话组列表/重命名/删除接口 ②历史消息查询接口 ⑤多 Agent/skill 分流 ⑥输入内容审核 —— v2 再议
...
- 访谈状态：16 问全部确认并经用户终审通过，本文档定版 v1.0。后续需求变更：先改本 PRD 再开发
